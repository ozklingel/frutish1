...
public class SignUp extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dataBaseb = FirebaseDatabase.getInstance().getReference().child("buyer");
        dataBases = FirebaseDatabase.getInstance().getReference().child("sailer");
                                ...
                                mAuth.getCurrentUser().sendEmailVerification().addOnCompleteListener(new OnCompleteListener<Void>() {
                                    ...
                                    public void onComplete(@NonNull Task<Void> task) {
                                        if(task.isSuccessful()){
                                            ...
                                            user.setPhone(Phone);
                                            user.setRole("buyer");
                                            dataBaseb.child(mAuth.getUid()).setValue(user);
                                            mAuth.signOut();
                                ...
                                mAuth.getCurrentUser().sendEmailVerification().addOnCompleteListener(new OnCompleteListener<Void>() {
                                    ...
                                    public void onComplete(@NonNull Task<Void> task) {
                                        if(task.isSuccessful()){
                                            ...
                                            user.setPhone(Phone);
                                            user.setRole("sailer");
                                            dataBases.child(mAuth.getUid()).setValue(user);
                                            mAuth.signOut();
                                            while(mAuth.getCurrentUser()!= null);
