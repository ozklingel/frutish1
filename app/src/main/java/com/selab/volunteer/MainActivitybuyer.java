    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        if (getItem != null) {
            ...
            button.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    final AlertDialog.Builder builder = new AlertDialog.Builder(MainActivitybuyer.this);
                    builder.setMessage("");
                    builder.setTitle("");
                    ...
                    builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int id) {
                            Intent intent = new Intent(MainActivitybuyer.this, welcom.class);
                            startActivity(intent);
                        }
                    });
                    builder.setNegativeButton("No", new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int id) {
                            ...
                            Toast.makeText(MainActivitybuyer.this, "good choose of button", Toast.LENGTH_SHORT).show();
                            dialog.cancel();
                        }
                    });
